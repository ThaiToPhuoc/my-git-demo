...
if(isset($_POST['tinh'])){
	...
	if(isset($_POST['hinh']) && ($_POST['hinh'])=="hv"){
        ...
        if(($_POST['dodai']) < 0 || !is_numeric($_POST['dodai']))
        {
            $str= "Không hợp lệ";
        }
        else
...
<fieldset>
	...
	<table border='0'>
        ...
        <input type="radio" name="hinh" value="htg"<?php if(isset($_POST['hinh'])&&($_POST['hinh'])=="htg") echo 'checked="checked"'?>/>Hình tam giác</td></tr>
